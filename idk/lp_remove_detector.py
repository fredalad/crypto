...
BURN_TOPIC0 = "0xdccd412f0b1252819cb1fd330b93224ca42612892bb3f4f789976e6d81936496"
...
def _decode_burn_amounts(data_hex: str) -> Dict[str, int]:
...
def detect_lp_removes(
    ...
    """
    Detect LP removes based on Burn events + LP burn + token return to wallet.
    """
    ...
    for log in normalized_logs:
        ...
        if not (lp_burn and t0_out and t1_out):
            continue
        ...
        actions.append(
            {
                ...
                "lp_tokens_burned": lp_burn.get("token_amount", 0),
                "tx_hash": tx_hash,
